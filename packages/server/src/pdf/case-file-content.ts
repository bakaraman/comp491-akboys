...
const STRINGS = {
  tr: {
    ...
    motiveLabel: 'Saik',
    coverFooter: 'The Velvet Shadow',
    pageLabel: 'Sayfa',
    locked: 'Mühürlü Dosya',
    /* Premium redesign (#pdf-premium) */
    classified: 'GİZLİ',
    eyesOnly: 'YALNIZ YETKİLİ',
    caseFileLabel: 'VAKA DOSYASI',
    bureauName: 'VELVET SHADOW DEDEKTİFLİK BÜROSU',
    bureauEst: 'KURULUŞ MMXXVI',
    suspectStamp: 'ŞÜPHELİ',
    chargedStamp: 'SUÇLU',
    clearedStamp: 'TEMİZ',
    fugitiveStamp: 'KAÇAK',
    filedBy: 'Hazırlayan',
    leadInvestigator: 'Baş Dedektif',
    dateLabel: 'Tarih',
    badgeLabel: 'Rozet',
    finalReport: 'NİHAİ RAPOR',
    synopsisLabel: 'SAHNE',
    incidentDate: 'OLAY GECESİ',
  },
  en: {
    caseFilePrefix: 'VS',
    ...
    bureauName: 'VELVET SHADOW DETECTIVE BUREAU',
    bureauEst: 'EST. MMXXVI',
    suspectStamp: 'SUSPECT',
    chargedStamp: 'CHARGED',
    clearedStamp: 'CLEARED',
    fugitiveStamp: 'FUGITIVE',
    filedBy: 'Filed by',
    ...
    synopsisLabel: 'SCENE',
    incidentDate: 'NIGHT OF INCIDENT',
  },
} as const;
